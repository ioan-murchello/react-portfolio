  ...
  return (
    <section>
      ...
      <motion.div
        ...
        initial="hidden"
        animate="show"
        className="grid gap-x-4 gap-y-5 rounded-xl p-5 grid-cols-1 md:grid-cols-2"
      >
        {sites.map((item) => {
          ...
          return (
            ...
            >
              <div className="bg-gray-100 transition-all duration-400 md:group-hover:bg-[#adadad] flex flex-col relative h-full overflow-hidden rounded-lg">
                <img
                  className="w-full h-full object-cover transition-all duration-300 sm:hover:scale-[1.05]"
                  src={image}
                  alt="foto"
                />
                <div className="bg-gray-600  text-white relative p-2">
